...
public class JianzhiyingpinController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,JianzhiyingpinEntity jianzhiyingpin, HttpServletRequest request){
		...
		if(tableName.equals("xuesheng")) {
			jianzhiyingpin.setXuehao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,JianzhiyingpinEntity jianzhiyingpin, HttpServletRequest request){
        EntityWrapper<JianzhiyingpinEntity> ew = new EntityWrapper<JianzhiyingpinEntity>();
		PageUtils page = jianzhiyingpinService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, jianzhiyingpin), params), params));
        return R.ok().put("data", page);
    }
