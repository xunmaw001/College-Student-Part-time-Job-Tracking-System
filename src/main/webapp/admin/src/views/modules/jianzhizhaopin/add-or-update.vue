      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="招聘标题" prop="zhaopinbiaoti">
          <el-input v-model="ruleForm.zhaopinbiaoti" 
              placeholder="招聘标题" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="招聘标题" prop="zhaopinbiaoti">
              <el-input v-model="ruleForm.zhaopinbiaoti" 
                placeholder="招聘标题" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="兼职岗位" prop="jianzhigangwei">
          <el-select v-model="ruleForm.jianzhigangwei" placeholder="请选择兼职岗位">
            <el-option
                v-for="(item,index) in jianzhigangweiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="兼职岗位" prop="jianzhigangwei">
	      <el-input v-model="ruleForm.jianzhigangwei"
                placeholder="兼职岗位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <el-form-item class="input" v-if="type!='info'"  label="岗位薪酬" prop="gangweixinchou">
          <el-input v-model="ruleForm.gangweixinchou" 
              placeholder="岗位薪酬" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="岗位薪酬" prop="gangweixinchou">
              <el-input v-model="ruleForm.gangweixinchou" 
                placeholder="岗位薪酬" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作天数" prop="gongzuotianshu">
          <el-input v-model="ruleForm.gongzuotianshu" 
              placeholder="工作天数" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作天数" prop="gongzuotianshu">
              <el-input v-model="ruleForm.gongzuotianshu" 
                placeholder="工作天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="工作时长" prop="gongzuoshizhang">
          <el-select v-model="ruleForm.gongzuoshizhang" placeholder="请选择工作时长">
            <el-option
                v-for="(item,index) in gongzuoshizhangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.gongzuoshizhang"
                placeholder="工作时长" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商家规模" prop="shangjiaguimo">
          <el-input v-model="ruleForm.shangjiaguimo" 
              placeholder="商家规模" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商家规模" prop="shangjiaguimo">
              <el-input v-model="ruleForm.shangjiaguimo" 
                placeholder="商家规模" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="商家地址" prop="shangjiadizhi">
              <el-input v-model="ruleForm.shangjiadizhi" 
                placeholder="商家地址" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="招聘封面" prop="zhaopinfengmian">
          <file-upload
          tip="点击上传招聘封面"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhaopinfengmian" label="招聘封面" prop="zhaopinfengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhaopinfengmian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
            ...
            ruleForm: {
                	        shangjiazhanghao: '',
	                        	        ...
	                        	        zhaopinxiangqing: '',
                                                                  ...
                                                                  jianzhigangweiOptions: [],
                                                                          gongzuoshizhangOptions: [],
                                                                                                        rules: {
                  shangjiazhanghao: [
                                    	                                                              ],
                  shangjiamingcheng: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='jianzhigangwei'){
            this.ruleForm.jianzhigangwei = obj[o];
            continue;
          }
                    if(o=='zhaopinrenshu'){
            ...
            continue;
                    ...
                    if(o=='gongzuotianshu'){
            this.ruleForm.gongzuotianshu = obj[o];
            continue;
          }
            ...
            continue;
                    ...
                    if(o=='shangjiaguimo'){
            this.ruleForm.shangjiaguimo = obj[o];
            continue;
          }
                    if(o=='lianxifangshi'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
                                    this.ruleForm.shangjiazhanghao = json.shangjiazhanghao
                                                this.ruleForm.shangjiamingcheng = json.shangjiamingcheng
                                                                                                                                                                                    this.ruleForm.shangjiaguimo = json.shangjiaguimo
          ...
          this.$message.error(data.msg);
                                                                                              ...
                                                                                              this.gongzuoshizhangOptions = "两小时,四小时,六小时,八小时,全日制".split(',')
                                                                                                                                        },
                                                                                                                        // 多级联动参数
                                                                                                                                                        info(id) {
      this.$http({
        url: `jianzhizhaopin/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jianzhizhaopin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jianzhizhaopinCrossAddOrUpdateFlag = false;
                  this.parent.search();
