          ...
          <el-form-item class="input" label="经营范围" prop="jingyingfanwei">
              <el-input v-model="ruleForm.jingyingfanwei" 
                placeholder="经营范围" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="商家规模" prop="shangjiaguimo">
          <el-select v-model="ruleForm.shangjiaguimo" placeholder="请选择商家规模">
            <el-option
                v-for="(item,index) in shangjiaguimoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.shangjiaguimo"
                placeholder="商家规模" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="法人代表" prop="farendaibiao">
          <el-input v-model="ruleForm.farendaibiao" 
              placeholder="法人代表" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="法人代表" prop="farendaibiao">
              <el-input v-model="ruleForm.farendaibiao" 
                placeholder="法人代表" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="商家地址" prop="shangjiadizhi">
              <el-input v-model="ruleForm.shangjiadizhi" 
                placeholder="商家地址" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="营业执照" prop="yingyezhizhao">
          <file-upload
          tip="点击上传营业执照"
          action="file/upload"
          :limit="3"
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                  ...
                                                                                                                  this.shangjiaguimoOptions = "小型企业,中型企业,大型企业,全国连锁".split(',')
                                                                                                    },
                                                                                // 多级联动参数
                                                                                                      info(id) {
      this.$http({
