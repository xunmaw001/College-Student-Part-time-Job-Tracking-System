          ...
          <el-form-item class="input" label="商家名称" prop="shangjiamingcheng">
              <el-input v-model="ruleForm.shangjiamingcheng" 
                placeholder="商家名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="投诉类型" prop="tousuleixing">
          <el-select v-model="ruleForm.tousuleixing" placeholder="请选择投诉类型">
            <el-option
          ...
          <el-form-item class="input" v-if="ruleForm.tousushijian" label="投诉时间" prop="tousushijian">
              <el-input v-model="ruleForm.tousushijian" 
                placeholder="投诉时间" readonly></el-input>
                                                                                                                          ...
                                                                                                                          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="投诉说明" prop="tousushuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="投诉说明"
                  v-model="ruleForm.tousushuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tousushuoming" label="投诉说明" prop="tousushuoming">
                    <span>{{ruleForm.tousushuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='tousushuoming'){
            this.ruleForm.tousushuoming = obj[o];
            continue;
          }
                    if(o=='sfsh'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shangjiatousu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shangjiatousuCrossAddOrUpdateFlag = false;
                  this.parent.search();
