  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="商家名称" prop="shangjiamingcheng">
              <el-input v-model="ruleForm.shangjiamingcheng" 
                placeholder="商家名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="投诉类型" prop="tousuleixing">
          <el-input v-model="ruleForm.tousuleixing" 
              placeholder="投诉类型" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="投诉类型" prop="tousuleixing">
              <el-input v-model="ruleForm.tousuleixing" 
                placeholder="投诉类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="处罚结果" prop="chufajieguo">
          <el-select v-model="ruleForm.chufajieguo" placeholder="请选择处罚结果">
            <el-option
                v-for="(item,index) in chufajieguoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="处罚结果" prop="chufajieguo">
	      <el-input v-model="ruleForm.chufajieguo"
                placeholder="处罚结果" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.chulishijian" label="处理时间" prop="chulishijian">
              <el-input v-model="ruleForm.chulishijian" 
                placeholder="处理时间" readonly></el-input>
                                                                                                            ...
                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="详情说明" prop="xiangqingshuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="详情说明"
                  v-model="ruleForm.xiangqingshuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiangqingshuoming" label="详情说明" prop="xiangqingshuoming">
                    <span>{{ruleForm.xiangqingshuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='tousuleixing'){
            this.ruleForm.tousuleixing = obj[o];
            continue;
          }
                    if(o=='chufajieguo'){
            this.ruleForm.chufajieguo = obj[o];
            continue;
          }
                    if(o=='fakuanjine'){
            ...
            continue;
                    ...
                    if(o=='xiangqingshuoming'){
            this.ruleForm.xiangqingshuoming = obj[o];
            continue;
          }
                    if(o=='ispay'){
