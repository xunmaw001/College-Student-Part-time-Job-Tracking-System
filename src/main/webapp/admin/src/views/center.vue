        ...
        <el-form-item  v-if="flag=='shangjia'"  label="经营范围" prop="jingyingfanwei">
          <el-input v-model="ruleForm.jingyingfanwei" 
              placeholder="经营范围" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item v-if="flag=='shangjia'"  label="商家规模" prop="shangjiaguimo">
          <el-select v-model="ruleForm.shangjiaguimo" placeholder="请选择商家规模">
            <el-option
                v-for="(item,index) in shangjiashangjiaguimoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="flag=='shangjia'"  label="法人代表" prop="farendaibiao">
    ...
    this.$http({
      ...
      if (data && data.code === 0) {
        ...
        this.$message.error(data.msg);
                                                    ...
                                                    this.shangjiashangjiaguimoOptions = "小型企业,中型企业,大型企业,全国连锁".split(',')
